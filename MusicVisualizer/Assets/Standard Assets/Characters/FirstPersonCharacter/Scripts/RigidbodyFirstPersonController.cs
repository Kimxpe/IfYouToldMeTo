...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            public float ForwardSpeed = 0.0f;   // Speed when walking forward
            public float BackwardSpeed = 0.0f;  // Speed when walking backwards
            public float StrafeSpeed = 0.0f;    // Speed when walking sideways
